...
export class FiltroPeliculaComponent implements OnInit {
  ...
  //Esto para que pueda limpiar el formulario mediante un boton
  formularioOriginal = {
    titulo: '',
    generoId: 0,
  ...
  ngOnInit(): void {
    ...
    //Para que aplique el filtro cargando la pag con la misma URL
    this.leerValoresURL();
    this.buscarPeliculas(this.form.value);

    this.form.valueChanges
      .subscribe(valores => {
        //recetea listado cada vez que se haga una busqueda
  ...
  private escribirParametrosBusquedaEnURL(){
    ...
    //con esto va reemplazando la URL con lo que voy escribiendo
