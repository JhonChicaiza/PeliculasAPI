...
export class AutocompleteActoresComponent implements OnInit {
  ...
  //permite manajear un campo de un formulario de manera individual
  ...
  //Para que se actualice la tabla con la foto de los actores
  ...
  optionSelected(event: MatAutocompleteSelectedEvent){
    ...
    //para actualizar tabla con viewchild
