...
namespace PeliculasAPI2.Controllers
{
    ...
    public class CinesController: ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<CineDTO>>> Get([FromQuery] PaginacionDTO paginacionDTO) // fromquery para la paginacion
        {
            ...
            return mapper.Map<List<CineDTO>>(cines); // toma listado de generos y los mapea a GenerosDTO
        }
